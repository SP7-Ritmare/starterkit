                                ...
                                <h4>
                                    <xsl:choose>
                                        ...
                                        <xsl:when test="contains(swe:Quantity/@definition, 'vocabs.lter-europe.net/EnvThes/')">
                                            ...
                                            <xsl:text> </xsl:text>
                                            <xsl:variable name="linkParam" select="swe:Quantity/@definition"/>
                                            <a href="{$linkParam}" data-title="{document(concat('http://vocabs.ceh.ac.uk/evn/tbl/describe?_base=urn:x-evn-pub:envthes&amp;_format=rdf%2Bxml&amp;_resource=', swe:Quantity/@definition))//skos:prefLabel}" target="_blank">
                                                <xsl:value-of select="document(concat('http://vocabs.ceh.ac.uk/evn/tbl/describe?_base=urn:x-evn-pub:envthes&amp;_format=rdf%2Bxml&amp;_resource=', swe:Quantity/@definition))//skos:prefLabel"/>
                                            </a>
                                        </xsl:when>
                            ...
                            <h4>
                                <xsl:choose>
                                    ...
                                    <xsl:when test="contains(swe:Category/@definition, 'vocabs.lter-europe.net/EnvThes/')">
                                        ...
                                        <xsl:text> </xsl:text>
                                        <xsl:variable name="linkParam" select="swe:Category/@definition"/>
                                        <a href="{$linkParam}" data-title="{document(concat('http://vocabs.ceh.ac.uk/evn/tbl/describe?_base=urn:x-evn-pub:envthes&amp;_format=rdf%2Bxml&amp;_resource=', swe:Category/@definition))//skos:prefLabel}" target="_blank">
                                            <xsl:value-of select="document(concat('http://vocabs.ceh.ac.uk/evn/tbl/describe?_base=urn:x-evn-pub:envthes&amp;_format=rdf%2Bxml&amp;_resource=', swe:Category/@definition))//skos:prefLabel"/>
                                        </a>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <i class="glyphicon glyphicon-link"/>
