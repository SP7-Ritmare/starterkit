...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mdtools_responsiblepartyscope', (
            ...
            ('scope', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'mdtools', ['ResponsiblePartyScope'])

        # Renaming column for 'MultiContactRole.scope' to match new field type.
        db.rename_column(u'mdtools_multicontactrole', 'scope', 'scope_id')
        # Changing field 'MultiContactRole.scope'
        db.alter_column(u'mdtools_multicontactrole', 'scope_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mdtools.ResponsiblePartyScope']))

        # Adding index on 'MultiContactRole', fields ['scope']
        db.create_index(u'mdtools_multicontactrole', ['scope_id'])


    def backwards(self, orm):
        
        # Removing index on 'MultiContactRole', fields ['scope']
        db.delete_index(u'mdtools_multicontactrole', ['scope_id'])

        # Deleting model 'ResponsiblePartyScope'
        db.delete_table(u'mdtools_responsiblepartyscope')

        # Renaming column for 'MultiContactRole.scope' to match new field type.
        db.rename_column(u'mdtools_multicontactrole', 'scope_id', 'scope')
        # Changing field 'MultiContactRole.scope'
        db.alter_column(u'mdtools_multicontactrole', 'scope', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 12, 8, 17, 56, 748565)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 12, 8, 17, 56, 754183)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 12, 8, 17, 56, 753580)'}),
        ...
        u'mdtools.responsiblepartyscope': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'scope': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        },
