...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mdtools_multicontactrole', (
            ...
            ('scope', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 11, 8, 29, 28, 357665)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 11, 8, 29, 28, 353349)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 11, 8, 29, 28, 352774)'}),
        ...
        u'mdtools.multicontactrole': {
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['people.Role']"}),
            'scope': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
