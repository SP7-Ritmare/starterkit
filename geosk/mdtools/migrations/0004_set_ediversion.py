...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for mdext in orm.MdExtension.objects.filter(ediversion__isnull=True):
            mdext.ediversion=1
            mdext.save()
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 10, 3, 53, 40, 399180)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 10, 3, 53, 40, 400869)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 10, 3, 53, 40, 400300)'}),
