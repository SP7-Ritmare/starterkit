...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ResponsiblePartyScope.scope'
        db.delete_column(u'mdtools_responsiblepartyscope', 'scope')

        # Adding field 'ResponsiblePartyScope.value'
        db.add_column(u'mdtools_responsiblepartyscope', 'value', self.gf('django.db.models.fields.CharField')(default='md_contact', unique=True, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ResponsiblePartyScope.scope'
        raise RuntimeError("Cannot reverse this migration. 'ResponsiblePartyScope.scope' and its values cannot be restored.")

        # Deleting field 'ResponsiblePartyScope.value'
        db.delete_column(u'mdtools_responsiblepartyscope', 'value')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 12, 8, 42, 15, 338725)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 12, 8, 42, 15, 340091)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 12, 8, 42, 15, 339516)'}),
