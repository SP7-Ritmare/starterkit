...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServicesMetadata.contact_phone'
        db.alter_column(u'mdtools_servicesmetadata', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'ServicesMetadata.contact_fax'
        db.alter_column(u'mdtools_servicesmetadata', 'contact_fax', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'ServicesMetadata.contact_phone'
        db.alter_column(u'mdtools_servicesmetadata', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'ServicesMetadata.contact_fax'
        db.alter_column(u'mdtools_servicesmetadata', 'contact_fax', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 18, 4, 6, 53916)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 18, 4, 6, 54965)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 18, 4, 6, 54394)'}),
