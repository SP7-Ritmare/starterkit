 ...
 *
 * Modified by Paolo Tagliolato, irea.cnr.it on 20140627 : 
 * exposed validateChanges publicly, adding this.validateChanges=validateChanges
 * (a workaround for resolving an issue with the order of validation and beforeChanges)
 */
...
Handsontable.Core = function (rootElement, userSettings) {
  ...
  /**
   * irea.cnr.it 20140627 modified - exposed validateChanges function publicly
   * workaround for an issue with the order of validation and beforeChanges.
  */
...
Handsontable.NumericValidator = function (value, callback) {
  console.log("validating value: "+value+"   test: ");
  if (value === null) {
    value = '';
  }
