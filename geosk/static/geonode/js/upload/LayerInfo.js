...
define(function (require, exports) {
    ...
    LayerInfo.prototype.displayUploadedLayerLinks = function(resp) {
        ...
        var b = '<a href="' + resp.url + '#ediclient_container" class="btn">Edit Metadata</a>';
    ...
    LayerInfo.prototype.setupGeogigDropdown = function(selector){
        ...
        $(selector).select2({
           ...
           formatResult: format,
           placeholder: 'Select or create a Geogig repository.',
    ...
    LayerInfo.prototype.doGeoGigToggle = function () {
